    ...
    WebDriverManager.chromedriver().setup();
        ...
        // Thread.sleep(3000); 
         ...
         driver.findElement(By.xpath("//*[@id=\'slot-booking\']/div/div[4]")).click();
          driver.findElement(By.className("mobile-number-input-container")).sendKeys("1234567892");
